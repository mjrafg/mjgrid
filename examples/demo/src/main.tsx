import { CssBaseline, FormControlLabel, Switch, Tab, Tabs, Box, Typography, useMediaQuery } from '@mui/material'
      ...
      <Box sx={{ display: 'flex', height: '100dvh' }}>
        <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', px: 2, borderBottom: '1px solid #ddd' }}>
            ...
            {!phone && <FormControlLabel control={<Switch checked={en} onChange={e => setEn(e.target.checked)} />} label="English labels" />}
          </Box>
